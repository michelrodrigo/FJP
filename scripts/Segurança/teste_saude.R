...
#source("https://gist.githubusercontent.com/michelrodrigo/15021ce633d95cc242d8d8edf5d53c5b/raw/e56163c6ea8f199c002afb1e58fb75bb4957695e/mortalidade_geral_mun_mg.R")
...
mortalidade_geral_mun_mg <- function(linha = "Munic%EDpio", coluna = "--N%E3o-Ativa--", conteudo = 1, periodo = "last", municipio = "all",
  ...
  categoria_cid10.df <- suppressWarnings(data.frame(id = page |> rvest::html_nodes("#S10 option") |> rvest::html_text() |> trimws(),
...
dados <- mortalidade_geral_mun_mg(periodo = 2021, 
                          sexo = "Masculino",
                          categoria_cid10 = "V01   Pedestre traum colis veic a pedal")
